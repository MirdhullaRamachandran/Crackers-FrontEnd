        ...
        <div className='footer-content'>
            <div className='container'>
                <div className='row'>
                    ...
                    <br></br>
                    Our License No.----.Thangathaai Fireworks Sivakasi a company following 100% legal & statutory compliances and all our shops, go-downs are maintained as per the explosive acts.
                    <br></br>
