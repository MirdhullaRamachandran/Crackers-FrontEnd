...
export default function Admin() {
    ...
    const updateData = (id, name, price, category, discount, image) => {
        ...
        axios.put(`https://web.thangathaaicrackers.com/api/crackers/${id}`, formData, {
            headers: {
                'Content-Type': 'multipart/form-data',
            },
        })
    ...
    const handleDeleteClick = (id) => {
        if (window.confirm('Are you sure you want to delete this cracker?')) {
            axios.delete(`https://web.thangathaaicrackers.com/api/crackers/${id}`)
                .then((res) => {
                    if (res.status === 200) {
